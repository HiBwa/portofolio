            ...
            <div class="row gx-5 align-items-center">
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        ...
                        <div class="fs-3 fw-light text-muted">{{ $biodata->bio }}</div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">{{ $biodata->motto }}</span>
                        </h1>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                href="{{ route('portofolio.resume', $data->username) }}">Resume</a>
                            <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
                                href="{{ route('portofolio.project', $data->username) }}">Projects</a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-7">
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            ...
                            <img class="profile-img" src="{{ url('images/foto/' . $biodata->foto) }}" alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">My name is {{ $biodata->nama_lengkap }}.</p>
                        <p class="text-muted">{{ $biodata->about }}</p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" target="_blank" href="{{ $biodata->twitter }}"><i
                                    class="bi bi-twitter"></i></a>
                            <a class="text-gradient" target="_blank" href="{{ $biodata->link_in }}"><i
                                    class="bi bi-linkedin"></i></a>
                            <a class="text-gradient" target="_blank" href="{{ $biodata->github }}"><i
