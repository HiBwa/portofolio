...
<head>
    ...
    <title>{{ $title }}</title>
    <link rel="shortcut icon" type="image/png" href="{{ asset('template/backend') }}/images/logos/favicon.png" />
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="#" class="text-nowrap logo-img">
                        <img src="{{ asset('template/backend') }}/images/logos/dark-logo.svg" width="180"
                            alt="" />
                    </a>
        ...
        <div class="body-wrapper">
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    ...
                                    <img src="{{ asset('template/backend') }}/images/profile/user-1.jpg" alt=""
            ...
            <div class="container-fluid">
                @include('layouts.backend.notifikasi')
                @yield('content')
                <div class="py-6 px-6 text-center">
                    <p class="mb-0 fs-4">Developed by <a href="#" target="_blank" class="pe-1 text-primary">Fikri
                            Ramadhani</a></p>
                </div>
            </div>
        </div>
