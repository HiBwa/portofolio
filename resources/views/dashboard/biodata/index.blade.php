                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->bio }}</td>
                                    <td>{{ $item->motto }}</td>
                                    <td><a href="{{ $item->link_in }}">{{ Str::limit($item->link_in, 5, '...') }}</a>
                                    </td>
                                    <td><a href="{{ $item->ig }}">{{ Str::limit($item->ig, 5, '...') }}</a></td>
                                    <td><a href="{{ $item->twitter }}">{{ Str::limit($item->twitter, 5, '...') }}</a>
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ route('biodata.edit', $item->id) }}"
                                            class="btn btn-sm btn-success">Update Biodata</a>
