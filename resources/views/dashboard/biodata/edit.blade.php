                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('biodata.update', $data->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" name="bio" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data->bio }}" placeholder="Biodata..">
                        </div>
                        <div class="mb-2">
                            <label for="exampleInputEmail1" class="form-label">Motto</label>
                            <input type="text" class="form-control" name="motto" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data->motto }}" placeholder="Motto..">
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <label for="exampleInputEmail1" class="form-label">Link In</label>
                            <input type="url" class="form-control" name="link_in" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data->link_in }}" placeholder="Url Link in">
                        </div>
                        <div class="mb-2">
                            <label for="exampleInputEmail1" class="form-label">Link Twitter</label>
                            <input type="url" class="form-control" name="twitter" id="exampleInputEmail1"
                                aria-describedby="emailHelp" value="{{ $data->twitter }}" placeholder=" Url Twitter">
                        </div>
                        <div class="mb-2">
