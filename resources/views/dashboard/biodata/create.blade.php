                    ...
                    <form method="POST" action="{{ route('biodata.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" name="bio" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Biodata..">
                        </div>
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" name="motto" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Motto..">
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="url" class="form-control" name="link_in" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Url Link in">
                        </div>
                        <div class="mb-2">
                            ...
                            <input type="url" class="form-control" name="twitter" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder=" Url Twitter">
                        </div>
                        <div class="mb-2">
