...
Route::get('/{username}', [FrontendController::class, 'index'])->name('portofolio.index');
Route::get('/{username}/resume', [FrontendController::class, 'resume'])->name('portofolio.resume');
Route::get('/{username}/user-project', [FrontendController::class, 'project'])->name('portofolio.project');
Route::get('/{username}/contact', [FrontendController::class, 'contact'])->name('portofolio.contact');
Route::post('/{username}/store/contact', [FrontendController::class, 'contactStore'])->name('portofolio-store.contact');
...
Route::prefix('dashboard')->middleware('auth')->group(
    function () {
        ...
        // bahasa pemograman
        Route::get('/bahasa-pemograman', [BahasaPemogramanController::class, 'index'])->name('bahasa-pemograman.index');
        Route::get('/bahasa-pemograman/create', [BahasaPemogramanController::class, 'create'])->name('bahasa-pemograman.create');
        Route::get('/bahasa-pemograman/{id}/show', [BahasaPemogramanController::class, 'show'])->name('bahasa-pemograman.show');
        Route::get('/bahasa-pemograman/{id}/edit', [BahasaPemogramanController::class, 'edit'])->name('bahasa-pemograman.edit');
        Route::patch('/bahasa-pemograman/{id}', [BahasaPemogramanController::class, 'update'])->name('bahasa-pemograman.update');
        Route::post('/bahasa-pemograman/store', [BahasaPemogramanController::class, 'store'])->name('bahasa-pemograman.store');
        Route::delete('/bahasa-pemograman/destroy/{id}', [BahasaPemogramanController::class, 'destroy'])->name('bahasa-pemograman.destroy');
